...
class Command(AppCommand):
    ...
    def handle_app_config(self, app_config, **options):
        ...
        if django.VERSION[1] == 7:
        ...
        elif (django.VERSION[1] >= 8) or (django.VERSION[0] >= 1):
            force = options['force']
            ...
            raise CommandError('You must be using Django 1.7 or hire')
        ...
        elif format == 'genericmodelviewset':
            generator = GenericModelViewSetGenerator(app_config, force)
        else:
            message = '\'%s\' is not a valid format. ' % options['format']
            message += '(viewset, modelviewset, apiview, function, genericmodelviewset)'
